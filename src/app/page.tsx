    ...
    <>
      ...
      <main className="relative text-white font-serif z-10">
        ...
        <section className="relative h-screen flex flex-col items-center justify-center text-center px-6 z-10">
          ...
          <p className="mt-4 text-lg text-[#c1a01e]" data-aos="fade-up" data-aos-delay="200">
        ...
        {/* Companies Section */}
        <section id="companies" className="relative px-6 py-20 space-y-20 z-10 bg-white text-[#1b1b4f]">
        ...
        {/* Team Section */}
        <section id="team" className="relative px-6 py-20 z-10 bg-white text-[#1b1b4f]">
          <h2 className="text-4xl font-bold text-center mb-10" data-aos="fade-up">Our Team</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-10">
            <div className="bg-gray-100 p-6 rounded text-center" data-aos="zoom-in">
            ...
            <div className="bg-gray-100 p-6 rounded text-center" data-aos="zoom-in" data-aos-delay="100">
              <Image src="/placeholder.jpg" alt="Team Member" width={100} height={100} className="mx-auto rounded-full" />
              <h4 className="mt-4 font-semibold">John Smith</h4>
              <p className="text-sm">Head of Strategy</p>
            </div>
            <div className="bg-gray-100 p-6 rounded text-center" data-aos="zoom-in" data-aos-delay="200">
              <Image src="/placeholder.jpg" alt="Team Member" width={100} height={100} className="mx-auto rounded-full" />
